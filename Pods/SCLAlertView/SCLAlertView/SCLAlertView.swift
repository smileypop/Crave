...
let kCircleHeightBackground: CGFloat = 64.0
...
open class SCLAlertView: UIViewController {
    ...
    fileprivate func setup() {
        ...
        circleView.frame = CGRect(x:x, y:appearance.kCircleTopPosition, width:appearance.kCircleHeight, height:appearance.kCircleHeight)
